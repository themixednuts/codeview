					...
					<div class="grid gap-4 lg:grid-cols-[minmax(0,1fr)_360px]">
						...
						>
							<div class="mb-3 flex items-center gap-2">
								...
								<h2 class="font-display text-lg font-semibold text-(--ink)">Allowance</h2>
							</div>
						...
						<section class="rounded-md border border-(--panel-border-soft) bg-(--panel) p-4">
							<div class="mb-3 flex items-center gap-2">
								...
								<h2 class="font-display text-lg font-semibold text-(--ink)">Force parse</h2>
							</div>
							<AdminForceParseForm />
							{#if actionMessage}
								<div
				...
				<section class="min-w-0">
					<div class="mb-3 flex items-center justify-between gap-3">
						<div class="flex min-w-0 items-center gap-2">
							...
							<h2 class="font-display text-lg font-semibold text-(--ink)">Active</h2>
						</div>
						...
						<div class="overflow-hidden rounded-md border border-(--panel-border-soft)">
							{#each visibleActiveEntries as entry (`${entry.name}@${entry.version}:${entry.requestId}`)}
								...
								>
									...
									<div class="truncate text-right font-mono text-xs text-(--muted-soft)">
