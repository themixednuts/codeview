/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.toml src/cloudflare.d.ts` (hash: 0a3e39b3c941b3964a7b89054d61ee93)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "GITHUB_OAUTH_CLIENT_ID" | "GITHUB_ADMIN_LOGINS" | "GITHUB_REPO" | "GITHUB_REF" | "GITHUB_WORKFLOW_FILE" | "PLAN_DRAIN_ACTIVE_TARGET" | "PLAN_DRAIN_BATCH_SIZE" | "GITHUB_ACTIONS_REPO_USAGE_TARGET_PERCENT" | "GITHUB_ACTIONS_MONTHLY_INCLUDED_MINUTES">> {}
}
