/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/cloudflare.d.ts` (hash: fbe9cf5053ede9e0f7c4760b9bda7828)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		GRAPH_STORE: DurableObjectNamespace /* GraphStore from codeview-services */;
		CRATE_REGISTRY: DurableObjectNamespace /* CrateRegistry from codeview-services */;
		PARSE_CRATE: Workflow /* ParseCrateWorkflow from codeview-services */;
	}
}
