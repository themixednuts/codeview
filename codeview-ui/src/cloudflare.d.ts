/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.toml src/cloudflare.d.ts` (hash: a217d898302a1d7a2a443dbc5afe5f70)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "GITHUB_ADMIN_LOGINS">> {}
}
