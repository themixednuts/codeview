...
export const TEXT_SIZE_KEY = 'codeview-text-size';
...
export const DENSITY_VALUES = [
	...
	'comfortable',
	'spacious',
] as const satisfies readonly DensityMode[];
export const TEXT_SIZE_VALUES = [
	'standard',
	'large',
	'extra-large',
] as const satisfies readonly TextSizeMode[];
export const VOICE_VALUES = [
	'editorial',
	'technical',
	'geometric',
] as const satisfies readonly VoiceMode[];
export const DOC_LAYOUT_VALUES = [
	'classic',
	'reading',
	'split',
] as const satisfies readonly DocLayoutMode[];
export const CODE_LIGHT_VALUES = [
	'solarized-light',
	'catppuccin-latte',
	'one-light',
	'github-light',
] as const satisfies readonly CodeTheme[];
export const CODE_DARK_VALUES = [
	'solarized-dark',
	'catppuccin-mocha',
	'one-dark',
	'github-dark',
...
export const SOURCE_PROVIDER_VALUES = [
	'auto',
	'crates-io',
	'github',
] as const satisfies readonly SourceProviderMode[];
