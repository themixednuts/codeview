...
class R2ReadError extends Schema.TaggedError<R2ReadError>()("R2ReadError", {
  key: Schema.String,
  cause: Schema.Defect(),
  message: Schema.String,
}) {}

class R2DecodeError extends Schema.TaggedError<R2DecodeError>()("R2DecodeError", {
  key: Schema.String,
  cause: Schema.Defect(),
  message: Schema.String,
}) {}

class R2ParseError extends Schema.TaggedError<R2ParseError>()("R2ParseError", {
  key: Schema.String,
  cause: Schema.Defect(),
  message: Schema.String,
}) {}
