/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./src/lib/server/cloudflare/workers/wrangler.toml ./src/lib/server/cloudflare/workers/cloudflare.d.ts` (hash: 4ea9cab9727c5e0306a8f47ba6bf538f)
// Runtime types generated with workerd@1.20260128.0 2025-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/index");
		durableNamespaces: "GraphStore" | "CrateRegistry";
	}
	interface Env {
		CRATE_GRAPHS: R2Bucket;
		GRAPH_STORE: DurableObjectNamespace<import("./dist/index").GraphStore>;
		CRATE_REGISTRY: DurableObjectNamespace<import("./dist/index").CrateRegistry>;
		PARSE_CRATE: Workflow<Parameters<import("./dist/index").ParseCrateWorkflow['run']>[0]['payload']>;
	}
}
...
interface RateLimit {
     ...
     * @see https://developers.cloudflare.com/workers/runtime-apis/bindings$cloudflare/ratelimit/
