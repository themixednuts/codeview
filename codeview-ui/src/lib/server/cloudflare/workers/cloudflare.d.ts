/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./src/lib/cloudflare/workers/wrangler.toml ./src/lib/cloudflare/workers/cloudflare.d.ts` (hash: 8f2e72fcfc54a0f9c01a0a8edde7432e)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GRAPH_STORE: DurableObjectNamespace<import("./src/index").GraphStore>;
		CRATE_REGISTRY: DurableObjectNamespace<import("./src/index").CrateRegistry>;
		PARSE_CRATE: Workflow<Parameters<import("./src/index").ParseCrateWorkflow['run']>[0]['payload']>;
	}
}
