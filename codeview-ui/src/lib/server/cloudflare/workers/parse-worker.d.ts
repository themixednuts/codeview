/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.parser.toml src/lib/server/cloudflare/workers/parse-worker.d.ts` (hash: 7c211f58086784e7998853c08c55e0fb)
