/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.parser.toml src/lib/server/cloudflare/workers/parse-worker.d.ts` (hash: 4946ae763a25967dd2ac1c517f2a5437)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../../../parse-worker");
		durableNamespaces: "ParseStatusDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_REPO" | "GITHUB_REF" | "GITHUB_WORKFLOW_FILE" | "PARSE_CALLBACK_BASE_URL" | "PARSE_DISPATCH_BURST" | "PARSE_DISPATCH_REFILL_SECONDS" | "DOCSRS_PARSE_BURST" | "DOCSRS_PARSE_REFILL_SECONDS" | "SYSROOT_PARSE_BURST" | "SYSROOT_PARSE_REFILL_SECONDS">> {}
}
