/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.parser.toml src/lib/server/cloudflare/workers/parse-worker.d.ts` (hash: da8267c58dfb1bf513940454df055363)
