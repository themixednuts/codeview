/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.parser.toml src/lib/server/cloudflare/workers/parse-worker.d.ts` (hash: dcc16970e44945608e3234d0e5eb9f15)
