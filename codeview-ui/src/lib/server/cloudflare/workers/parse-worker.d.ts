/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.parser.toml src/lib/server/cloudflare/workers/parse-worker.d.ts` (hash: 6803c811a129fa31e114f26e316e64ef)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_REPO" | "GITHUB_REF" | "GITHUB_WORKFLOW_FILE" | "PARSE_CALLBACK_BASE_URL" | "PARSE_DISPATCH_BURST" | "PARSE_DISPATCH_REFILL_SECONDS" | "DOCSRS_PARSE_BURST" | "DOCSRS_PARSE_REFILL_SECONDS" | "SYSROOT_PARSE_BURST" | "SYSROOT_PARSE_REFILL_SECONDS" | "PLAN_DRAIN_ACTIVE_TARGET" | "PLAN_DRAIN_BATCH_SIZE" | "GITHUB_ACTIONS_REPO_USAGE_TARGET_PERCENT" | "GITHUB_ACTIONS_MONTHLY_INCLUDED_MINUTES">> {}
}
