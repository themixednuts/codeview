...
export const nodeDetails = sqliteTable(
	...
	(table) => [
		primaryKey({ columns: [table.ecosystem, table.crateName, table.crateVersion, table.nodeId] })
	]
);
...
export const edges = sqliteTable(
	...
	(table) => [
		primaryKey({
			columns: [table.ecosystem, table.crateName, table.crateVersion, table.fromId, table.toId, table.kind]
		})
	]
);
