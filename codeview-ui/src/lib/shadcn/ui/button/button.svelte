...
<button
	...
	data-slot="button"
	class={cn(
		"corner-squircle inline-flex items-center justify-center gap-1.5 rounded-(--radius-control) font-medium whitespace-nowrap transition-colors focus-visible:ring-(--accent) focus-visible:ring-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
